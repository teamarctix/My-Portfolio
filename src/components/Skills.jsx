    ...
    <div className="grid md:grid-cols-2 gap-8 relative z-10">
      {skillsData.map((category, i) => (
        <div
          key={i}
          data-aos="fade-up"
          className="bg-[#F8F8FC] dark:bg-[#272757] border border-gray-200 dark:border-[#505081] p-6 rounded-xl shadow-sm hover:shadow-md transition"
        >
              ...
              <li key={j}>
                <div className="flex items-center justify-between mb-1">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-medium text-sm text-[#272757] dark:text-white">{name}</span>
                  </div>
